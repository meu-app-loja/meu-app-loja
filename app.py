...
# --- FUNÇÃO DE LIMPEZA E CONVERSÃO DE NÚMEROS (MANTIDA COMO VOCÊ ENVIOU) ---
...
# --- SALVAR NA NUVEM (CORRIGIDO: NÃO “QUEBRA” DECIMAIS NO SHEETS) ---
def salvar_na_nuvem(nome_aba, df, colunas_padrao):
    try:
        ...
        # ✅ CORREÇÃO: não usar fillna("") em tudo (isso transforma números em texto)
        for col in df_save.columns:
        ...
        # ✅ CORREÇÃO: RAW evita o Sheets reinterpretar e tirar a vírgula/ponto decimal
        ws.update(
